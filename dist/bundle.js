...
function setCurrentTemp(locationData) {
  ...
  if (units === 'imperial') {
    currentTemp.textContent = "".concat(locationData.tempF);
  } else if (units === 'metric') {
    currentTemp.textContent = "".concat(locationData.tempC);
  }
}
function setHighTemp(locationData) {
  ...
  var units = (0,_toggleUnits__WEBPACK_IMPORTED_MODULE_1__.getUnitsValue)();
  if (units === 'imperial') {
    highTemp.textContent = "".concat(locationData.maxTempF);
  } else if (units === 'metric') {
    highTemp.textContent = "".concat(locationData.maxTempC);
  }
}
...
function setLowTemp(locationData) {
  ...
  var units = (0,_toggleUnits__WEBPACK_IMPORTED_MODULE_1__.getUnitsValue)();
  if (units === 'imperial') {
    lowTemp.textContent = "".concat(locationData.minTempF);
  } else if (units === 'metric') {
    lowTemp.textContent = "".concat(locationData.minTempC);
  }
}
...
function createForecastCard(forecast) {
  ...
  if (units === 'imperial') {
    highTempData.textContent = "".concat(forecast.maxTempF);
  } else if (units === 'metric') {
    highTempData.textContent = "".concat(forecast.maxTempC);
  }
  var lowTempData = document.createElement('h2');
  lowTempData.classList.add('forecast-data');
  if (units === 'imperial') {
    lowTempData.textContent = "".concat(forecast.minTempF);
  } else if (units === 'metric') {
    lowTempData.textContent = "".concat(forecast.minTempC);
  }
...
function processInput() {
  ...
  (0,_renderDom__WEBPACK_IMPORTED_MODULE_0__.renderForecast)(inputValue, 3);
...
`, "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AAAA;EACE,8BAA8B;EAC9B,gCAAgC;EAChC,gCAAgC;EAChC,oCAAoC;EACpC,kCAAkC;EAClC,kCAAkC;EAClC,gCAAgC;AAClC;;AAEA;;EAEE,4DAA4D;EAC5D,8DAA8D;EAC9D,6CAA6C;EAC7C,4BAA4B;AAC9B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,sBAAsB;AACxB;;AAEA;EACE,sBAAsB;EACtB,mCAAmC;EACnC,qCAAqC;EACrC,iCAAiC;EACjC,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,6BAA6B;EAC7B,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,qCAAqC;AACvC;;AAEA;EACE,YAAY;EACZ,uCAAuC;AACzC;;AAEA;EACE,eAAe;EACf,aAAa;EACb,8BAA8B;EAC9B,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,6BAA6B;EAC7B,0BAA0B;EAC1B,aAAa;EACb,sBAAsB;EACtB,wBAAwB;AAC1B;;AAEA;EACE,0BAA0B;EAC1B,YAAY;EACZ,sBAAsB;EACtB,YAAY;AACd;;AAEA;EACE,sBAAsB;EACtB,YAAY;EACZ,6BAA6B;EAC7B,YAAY;AACd;;AAEA;EACE,sBAAsB;EACtB,aAAa;EACb,8BAA8B;EAC9B,SAAS;EACT,6BAA6B;AAC/B;;AAEA;EACE;IACE,WAAW;EACb;EACA;IACE,sBAAsB;IACtB,mBAAmB;EACrB;AACF;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,kBAAkB;AACpB;;AAEA;EACE,sBAAsB;EACtB,kBAAkB;EAClB,kBAAkB;AACpB;;AAEA;EACE,sBAAsB;EACtB,kBAAkB;AACpB;;AAEA;EACE,sBAAsB;EACtB,sBAAsB;EACtB,6BAA6B;EAC7B,6BAA6B;EAC7B,aAAa;EACb,UAAU;EACV,sBAAsB;EACtB,kBAAkB;EAClB,aAAa;EACb,YAAY;AACd;;AAEA;;EAEE,UAAU;EACV,sBAAsB;EACtB,aAAa;AACf;;AAEA;EACE,uBAAuB;EACvB,YAAY;AACd;;AAEA;EACE,6BAA6B;EAC7B,YAAY;AACd;;AAEA;EACE,6BAA6B;EAC7B,YAAY;AACd;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,UAAU;EACV,aAAa;EACb,6CAA6C;EAC7C,qBAAqB;EACrB,SAAS;AACX;;AAEA;EACE,eAAe;EACf,aAAa;EACb,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,wBAAwB;EACxB,cAAc;AAChB;;AAEA;EACE,sBAAsB;EACtB,oBAAoB;AACtB;;AAEA;EACE,sBAAsB;EACtB,kBAAkB;EAClB,sBAAsB;AACxB;;AAEA;EACE,UAAU;EACV,aAAa;EACb,qCAAqC;EACrC,SAAS;EACT,mBAAmB;AACrB;;AAEA;EACE;IACE,WAAW;EACb;EACA;IACE,WAAW;EACb;AACF;;AAEA;EACE;IACE,2DAA2D;EAC7D;AACF;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,aAAa;EACb,oCAAoC;EACpC,kCAAkC;EAClC,mBAAmB;EACnB,0CAA0C;EAC1C,2CAA2C;EAC3C,sBAAsB;EACtB,yBAAyB;AAC3B;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,wBAAwB;EACxB,cAAc;AAChB;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,eAAe;EACf,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,kBAAkB;EAClB,mBAAmB;EACnB,kBAAkB;EAClB,eAAe;EACf,sBAAsB;EACtB,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,2DAA2D;EAC3D,WAAW;EACX,SAAS;AACX;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,mBAAmB;EACnB,SAAS;EACT,kCAAkC;EAClC,aAAa;EACb,mBAAmB;EACnB,6BAA6B;AAC/B;;AAEA;EACE,wBAAwB;EACxB,cAAc;AAChB;;AAEA;EACE,sBAAsB;AACxB;;AAEA;;EAEE,sBAAsB;EACtB,kBAAkB;AACpB","sourcesContent":["html {\n  --fs-1: clamp(4rem, 8vw, 8rem);\n  --fs-2: clamp(1.5rem, 3vw, 2rem);\n  --fs-3: clamp(1rem, 3vw, 1.5rem);\n  --fs-4: clamp(0.75rem, 2vw, 1.25rem);\n  --icon-1: clamp(8rem, 16vw, 16rem);\n  --icon-2: clamp(3.5rem, 6vw, 5rem);\n  --border: clamp(1rem, 3vw, 3rem);\n}\n\nhtml,\nbody {\n  --day-gradient: linear-gradient(to bottom, #49d5ff, #dcf5ff);\n  --night-gradient: linear-gradient(to bottom, #120052, #4700b9);\n  --box-shadow: 7px 7px 15px rgba(0, 0, 0, 0.6);\n  background-attachment: fixed;\n}\n\n#body-container {\n  height: 100vh;\n  box-sizing: border-box;\n  padding: var(--border);\n}\n\n#weather-app-container {\n  font-family: 'Archivo';\n  --primary-color: rgb(142, 180, 255);\n  --day-color: rgba(255, 255, 255, 0.2);\n  --night-color: rgba(0, 0, 0, 0.2);\n  display: flex;\n  flex-direction: column;\n  gap: 72px;\n  background-color: transparent;\n  height: 100%;\n}\n\n.day-theme {\n  color: black;\n  background-image: var(--day-gradient);\n}\n\n.night-theme {\n  color: white;\n  background-image: var(--night-gradient);\n}\n\n#nav-container {\n  grid-row: 1 / 2;\n  display: flex;\n  justify-content: space-between;\n  width: 100%;\n  margin-bottom: 36px;\n}\n\n#search-container {\n  box-shadow: var(--box-shadow);\n  border-radius: 0 7px 7px 0;\n  display: flex;\n  align-self: flex-start;\n  justify-self: flex-start;\n}\n\n#user-input {\n  border-radius: 7px 0 0 7px;\n  padding: 7px;\n  font-size: var(--fs-4);\n  border: none;\n}\n\n#search-button {\n  font-size: var(--fs-4);\n  padding: 7px;\n  background-color: transparent;\n  border: none;\n}\n\n#current-data-container {\n  box-sizing: border-box;\n  display: flex;\n  justify-content: space-between;\n  gap: 4rem;\n  background-color: transparent;\n}\n\n@media (max-width: 1325px) {\n  #condition-container {\n    width: 100%;\n  }\n  #current-data-container {\n    flex-direction: column;\n    align-items: center;\n  }\n}\n\n#name-info-container {\n  display: flex;\n  flex-direction: column;\n  gap: 14px;\n  align-self: center;\n}\n\n#location-name {\n  font-size: var(--fs-1);\n  align-self: center;\n  text-align: center;\n}\n\n#updated-time {\n  font-size: var(--fs-3);\n  align-self: center;\n}\n\n#unit-toggle {\n  align-self: flex-start;\n  justify-self: self-end;\n  box-shadow: var(--box-shadow);\n  background-color: transparent;\n  display: flex;\n  padding: 0;\n  font-size: var(--fs-4);\n  border-radius: 7px;\n  outline: none;\n  border: none;\n}\n\n#imperial,\n#metric {\n  width: 50%;\n  box-sizing: border-box;\n  padding: 10px;\n}\n\n.active-unit {\n  background-color: white;\n  color: black;\n}\n\n.inactive-unit-day {\n  background-color: transparent;\n  color: black;\n}\n\n.inactive-unit-night {\n  background-color: transparent;\n  color: white;\n}\n\n#imperial {\n  border-radius: 7px 0 0 7px;\n}\n\n#metric {\n  border-radius: 0 7px 7px 0;\n}\n\n#condition-container {\n  width: 50%;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, auto);\n  grid-template-rows: 2;\n  gap: 50px;\n}\n\n#icon-container {\n  grid-row: 1 / 3;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.condition-image {\n  font-size: var(--icon-1);\n  color: inherit;\n}\n\n#current-temp {\n  font-size: var(--fs-1);\n  align-self: self-end;\n}\n\n.condition-desc {\n  font-size: var(--fs-2);\n  grid-column: 2 / 3;\n  align-self: self-start;\n}\n\n#info-container {\n  width: 50%;\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 2rem;\n  place-items: center;\n}\n\n@media (max-width: 1325px) {\n  #condition-container {\n    width: 100%;\n  }\n  #info-container {\n    width: 100%;\n  }\n}\n\n@media (max-width: 1850px) {\n  #info-container {\n    grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));\n  }\n}\n\n.info-card {\n  width: 100%;\n  height: 100%;\n  display: grid;\n  grid-template-columns: 8rem 1fr auto;\n  grid-template-rows: repeat(2, 1fr);\n  border-radius: 12px;\n  background-color: rgba(255, 255, 255, 0.2);\n  box-shadow: 7px 7px 15px rgba(0, 0, 0, 0.6);\n  box-sizing: border-box;\n  padding: 20px 32px 20px 0;\n}\n\n.info-icon-container {\n  grid-column: 1 / 2;\n  grid-row: 1 / 3;\n  display: grid;\n  place-items: center;\n}\n\n.info-icon {\n  font-size: var(--icon-2);\n  color: inherit;\n}\n\n.info-header {\n  align-self: center;\n  grid-column: 3 / 4;\n  grid-row: 1 / 2;\n  font-size: var(--fs-3);\n  margin-bottom: 12px;\n}\n\n.info-value {\n  align-self: center;\n  white-space: nowrap;\n  grid-column: 3 / 4;\n  grid-row: 2 / 3;\n  font-size: var(--fs-2);\n  margin-top: 12px;\n}\n\n#forecast-container {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n  width: 100%;\n  gap: 4rem;\n}\n\n.forecast-card {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  gap: 2rem;\n  background-color: var(--day-color);\n  padding: 30px;\n  border-radius: 12px;\n  box-shadow: var(--box-shadow);\n}\n\n.forecast-icon {\n  font-size: var(--icon-2);\n  color: inherit;\n}\n\n.forecast-data {\n  font-size: var(--fs-2);\n}\n\n.forecast-condition,\n.forecast-day {\n  font-size: var(--fs-3);\n  text-align: center;\n}\n"],"sourceRoot":""}]);
// Exports
...
function _init() {
  _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var position, _position$coords, latitude, longitude, currentLocation;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 3:
          ...
          currentLocation = "".concat(latitude) + ', ' + "".concat(longitude);
          _context.next = 8;
          return (0,_toggleUnits__WEBPACK_IMPORTED_MODULE_6__.toggleUnitTheme)((0,_toggleUnits__WEBPACK_IMPORTED_MODULE_6__.getUnitsValue)(), currentLocation);
        case 8:
          _context.next = 10;
          return (0,_renderDom__WEBPACK_IMPORTED_MODULE_4__["default"])(currentLocation);
        case 10:
          _context.next = 12;
          return (0,_renderDom__WEBPACK_IMPORTED_MODULE_4__.renderForecast)(currentLocation, 3);
        case 12:
          _context.next = 17;
          break;
        case 14:
...
unitToggle.addEventListener('click', function () {
  ...
  (0,_renderDom__WEBPACK_IMPORTED_MODULE_4__.renderForecast)(location, 3);
});
})();
