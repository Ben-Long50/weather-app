...
/* harmony export */   "default": () => (/* binding */ setConditionImage)
/* harmony export */ });
...
function setConditionImage(_x) {
  return _setConditionImage.apply(this, arguments);
}
function _setConditionImage() {
  _setConditionImage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(location) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          conditionImage.src = location.icon;
        case 1:
        case "end":
...
`, "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AAAA;;EAEE,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,gCAAgC;EAChC,oCAAoC;EACpC,sBAAsB;EACtB,YAAY;EACZ,WAAW;EACX,aAAa;EACb,oCAAoC;EACpC,iCAAiC;EACjC,SAAS;EACT,aAAa;EACb,wCAAwC;AAC1C;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,mCAAmC;EACnC,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,mCAAmC;EACnC,uBAAuB;EACvB,mBAAmB;AACrB","sourcesContent":["html,\nbody {\n  height: 100%;\n  width: 100%;\n}\n\n#weather-app-container {\n  --main-color: rgb(142, 180, 255);\n  --secondary-color: rgb(86, 151, 255);\n  box-sizing: border-box;\n  height: 100%;\n  width: 100%;\n  display: grid;\n  grid-template-columns: repeat(4 1fr);\n  grid-template-rows: repeat(2 1fr);\n  gap: 20px;\n  padding: 20px;\n  background-color: var(--secondary-color);\n}\n\n#current-data-container {\n  grid-row: 1 / 2;\n  grid-column: 1 / 5;\n  background-color: var(--main-color);\n  border: solid black 1px;\n  border-radius: 10px;\n}\n\n.future-data-container {\n  grid-row: 2 / 3;\n  background-color: var(--main-color);\n  border: solid black 1px;\n  border-radius: 10px;\n}\n"],"sourceRoot":""}]);
// Exports
...
var selectedLocation = getLocationData('huntington beach');
(0,_renderDom__WEBPACK_IMPORTED_MODULE_2__["default"])(selectedLocation);
