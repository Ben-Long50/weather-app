...
`, "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AAAA;;EAEE,4DAA4D;EAC5D,8DAA8D;EAC9D,aAAa;EACb,YAAY;EACZ,4BAA4B;AAC9B;;AAEA;EACE,sBAAsB;EACtB,aAAa;AACf;;AAEA;EACE;IACE,aAAa;EACf;AACF;;AAEA;EACE,sBAAsB;EACtB,mCAAmC;EACnC,qCAAqC;EACrC,iCAAiC;;EAEjC,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,6BAA6B;EAC7B,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,qCAAqC;AACvC;;AAEA;EACE,YAAY;EACZ,uCAAuC;AACzC;;AAEA;EACE,eAAe;EACf,aAAa;EACb,8BAA8B;EAC9B,WAAW;AACb;;AAEA;EACE,2CAA2C;EAC3C,0BAA0B;EAC1B,aAAa;EACb,sBAAsB;EACtB,wBAAwB;AAC1B;;AAEA;EACE,0BAA0B;EAC1B,YAAY;EACZ,eAAe;EACf,YAAY;AACd;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,6BAA6B;EAC7B,YAAY;AACd;;AAEA;EACE,sBAAsB;EACtB,aAAa;EACb,YAAY;EACZ,8BAA8B;EAC9B,6BAA6B;AAC/B;;AAEA;EACE;IACE,sBAAsB;EACxB;AACF;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,OAAO;EACP,kBAAkB;AACpB;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,sBAAsB;EACtB,sBAAsB;EACtB,2CAA2C;EAC3C,6BAA6B;EAC7B,aAAa;EACb,UAAU;EACV,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,YAAY;AACd;;AAEA;;EAEE,UAAU;EACV,sBAAsB;EACtB,aAAa;AACf;;AAEA;EACE,uBAAuB;EACvB,YAAY;AACd;;AAEA;EACE,6BAA6B;EAC7B,YAAY;AACd;;AAEA;EACE,6BAA6B;EAC7B,YAAY;AACd;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,aAAa;EACb,qCAAqC;EACrC,qBAAqB;EACrB,SAAS;AACX;;AAEA;EACE,eAAe;EACf,aAAa;EACb,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,gBAAgB;EAChB,cAAc;AAChB;;AAEA;EACE,mBAAmB;EACnB,gBAAgB;EAChB,oBAAoB;AACtB;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,sBAAsB;AACxB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,qCAAqC;EACrC,SAAS;EACT,mBAAmB;AACrB;;AAEA;EACE;IACE,2DAA2D;EAC7D;AACF;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,aAAa;EACb,+BAA+B;EAC/B,kCAAkC;EAClC,SAAS;EACT,kBAAkB;EAClB,0CAA0C;EAC1C,2CAA2C;EAC3C,sBAAsB;EACtB,aAAa;AACf;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,eAAe;EACf,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,cAAc;AAChB;;AAEA;EACE,oBAAoB;EACpB,kBAAkB;EAClB,eAAe;EACf,eAAe;AACjB;;AAEA;EACE,mBAAmB;EACnB,kBAAkB;EAClB,eAAe;EACf,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,2DAA2D;EAC3D,WAAW;EACX,OAAO;AACT;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,mBAAmB;EACnB,SAAS;EACT,kCAAkC;EAClC,aAAa;EACb,mBAAmB;EACnB,2CAA2C;AAC7C;;AAEA;EACE,eAAe;EACf,cAAc;AAChB;;AAEA;EACE,eAAe;AACjB;;AAEA;;EAEE,eAAe;EACf,kBAAkB;AACpB","sourcesContent":["html,\nbody {\n  --day-gradient: linear-gradient(to bottom, #49d5ff, #dcf5ff);\n  --night-gradient: linear-gradient(to bottom, #120052, #4700b9);\n  height: 100vh;\n  width: 100vw;\n  background-attachment: fixed;\n}\n\nbody {\n  box-sizing: border-box;\n  padding: 80px;\n}\n\n@media (max-width: 1000px) {\n  body {\n    padding: 40px;\n  }\n}\n\n#weather-app-container {\n  font-family: 'Archivo';\n  --primary-color: rgb(142, 180, 255);\n  --day-color: rgba(255, 255, 255, 0.2);\n  --night-color: rgba(0, 0, 0, 0.2);\n\n  display: flex;\n  flex-direction: column;\n  gap: 60px;\n  background-color: transparent;\n  height: 100%;\n}\n\n.day-theme {\n  color: black;\n  background-image: var(--day-gradient);\n}\n\n.night-theme {\n  color: white;\n  background-image: var(--night-gradient);\n}\n\n#nav-container {\n  grid-row: 1 / 2;\n  display: flex;\n  justify-content: space-between;\n  width: 100%;\n}\n\n#search-container {\n  box-shadow: 7px 7px 15px rgba(0, 0, 0, 0.6);\n  border-radius: 0 7px 7px 0;\n  display: flex;\n  align-self: flex-start;\n  justify-self: flex-start;\n}\n\n#user-input {\n  border-radius: 7px 0 0 7px;\n  padding: 7px;\n  font-size: 24px;\n  border: none;\n}\n\n#search-button {\n  font-size: 24px;\n  padding: 7px;\n  background-color: transparent;\n  border: none;\n}\n\n#current-data-container {\n  box-sizing: border-box;\n  display: flex;\n  flex-grow: 1;\n  justify-content: space-between;\n  background-color: transparent;\n}\n\n@media (max-width: 1000px) {\n  #current-data-container {\n    flex-direction: column;\n  }\n}\n\n#name-info-container {\n  display: flex;\n  flex-direction: column;\n  gap: 14px;\n  flex: 1;\n  align-self: center;\n}\n\n#location-name {\n  font-size: 10vh;\n  align-self: center;\n  text-align: center;\n}\n\n#updated-time {\n  align-self: center;\n}\n\n#unit-toggle {\n  align-self: flex-start;\n  justify-self: self-end;\n  box-shadow: 7px 7px 15px rgba(0, 0, 0, 0.6);\n  background-color: transparent;\n  display: flex;\n  padding: 0;\n  font-size: 24px;\n  border-radius: 7px;\n  outline: none;\n  border: none;\n}\n\n#imperial,\n#metric {\n  width: 50%;\n  box-sizing: border-box;\n  padding: 10px;\n}\n\n.active-unit {\n  background-color: white;\n  color: black;\n}\n\n.inactive-unit-day {\n  background-color: transparent;\n  color: black;\n}\n\n.inactive-unit-night {\n  background-color: transparent;\n  color: white;\n}\n\n#imperial {\n  border-radius: 7px 0 0 7px;\n}\n\n#metric {\n  border-radius: 0 7px 7px 0;\n}\n\n#condition-container {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: 2;\n  gap: 50px;\n}\n\n#icon-container {\n  grid-row: 1 / 3;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.condition-image {\n  font-size: 250px;\n  color: inherit;\n}\n\n#current-temp {\n  white-space: nowrap;\n  font-size: 100px;\n  align-self: self-end;\n}\n\n.condition-desc {\n  font-size: 30px;\n  grid-column: 2 / 3;\n  align-self: self-start;\n}\n\n#info-container {\n  flex-grow: 1;\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 36px;\n  place-items: center;\n}\n\n@media (max-width: 1850px) {\n  #info-container {\n    grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));\n  }\n}\n\n.info-card {\n  width: 100%;\n  height: 100%;\n  display: grid;\n  grid-template-columns: 8rem 1fr;\n  grid-template-rows: repeat(2, 1fr);\n  gap: 15px;\n  border-radius: 7px;\n  background-color: rgba(255, 255, 255, 0.2);\n  box-shadow: 7px 7px 15px rgba(0, 0, 0, 0.6);\n  box-sizing: border-box;\n  padding: 10px;\n}\n\n.info-icon-container {\n  font-size: 5rem;\n  grid-column: 1 / 2;\n  grid-row: 1 / 3;\n  display: grid;\n  place-items: center;\n}\n\n.info-icon {\n  font-size: 1em;\n  color: inherit;\n}\n\n.info-header {\n  align-self: self-end;\n  grid-column: 2 / 3;\n  grid-row: 1 / 2;\n  font-size: 20px;\n}\n\n.info-value {\n  white-space: nowrap;\n  grid-column: 2 / 3;\n  grid-row: 2 / 3;\n  font-size: 30px;\n}\n\n#forecast-container {\n  display: grid;\n  flex-grow: 1;\n  grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n  width: 100%;\n  gap: 4%;\n}\n\n.forecast-card {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  gap: 15px;\n  background-color: var(--day-color);\n  padding: 30px;\n  border-radius: 10px;\n  box-shadow: 7px 7px 15px rgba(0, 0, 0, 0.6);\n}\n\n.forecast-icon {\n  font-size: 70px;\n  color: inherit;\n}\n\n.forecast-data {\n  font-size: 36px;\n}\n\n.forecast-condition,\n.forecast-day {\n  font-size: 20px;\n  text-align: center;\n}\n"],"sourceRoot":""}]);
// Exports
...
(0,_renderDom__WEBPACK_IMPORTED_MODULE_4__.renderForecast)('london', 3);
// fetchConditionData();
